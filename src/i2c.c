...
EE14Lib_Err i2c_init(I2C_TypeDef* i2c, EE14Lib_Pin scl, EE14Lib_Pin sda)
{
    ...
    // These numbers give roughly 400kHz timing with a 4MHz clock, but you'll
    // need a good (1k-ohm) pullup to get fast enough rise times.
//    i2c->TIMINGR |= 0 << I2C_TIMINGR_PRESC_Pos | // Prescaler (1x)
//                    0 << I2C_TIMINGR_SCLDEL_Pos | // Sync delay is long enough, don't need additional setup time
//                    0 << I2C_TIMINGR_SDADEL_Pos | // ... and don't need additional hold time
